...
public:
    ...
    void setupUi(QMainWindow *XGD_HOST)
    {
        ...
        pushButton_StartTrans->setGeometry(QRect(20, 340, 101, 41));
        ...
        plainTextEdit_Message->setGeometry(QRect(3, 20, 461, 551));
        ...
        verticalScrollBar_Message->setGeometry(QRect(442, 21, 21, 549));
        ...
        tabWidget_Settings->setCurrentIndex(2);
    ...
    void retranslateUi(QMainWindow *XGD_HOST)
    {
        ...
        lineEdit_IPAddress->setText(QCoreApplication::translate("XGD_HOST", "127.0.0.1", nullptr));
